...
/**
 * Created by Rajareddy on 02/08/16.
 */
public class MyView extends View {
    ...
    public MyView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SmileyView, defStyleAttr, R.style.DefaultSmileyStyle);
    ...
    private void initPaints() {
        ...
        mCirclePaint.setColor(mFaceColor);
